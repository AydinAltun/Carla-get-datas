    ...
    try:
        ...
        while True:
            ...
            low_data = {
                        ...
                        "locX" :world.player.get_transform().location.x,
                        "locY" :world.player.get_transform().location.y,
                        "locZ": world.player.get_transform().location.z,
                        ...
                        "heading":world.imu_sensor.compass,
                        "distance":math.sqrt(( world.player.get_transform().location.x)**2 +
                                             (world.player.get_transform().location.y)**2 + (world.player.get_transform().location.z)**2),

                        "latitude":world.gnss_sensor.lat,
                        "longitude":world.gnss_sensor.lon,
                        "altitude":world.gnss_sensor.alt,
